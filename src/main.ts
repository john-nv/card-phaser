...
// import MainGame from './main-game-card'
// import BomBom from './bombom/bombom'
// import TitleBomBom from './bombom/titleScene'

// const bombom = new BomBom()
// const titleBomBom = new TitleBomBom()
...
// game.scene.add('bombom', bombom)
// game.scene.add('titleBomBom', titleBomBom)
// game.scene.start('bombom')
